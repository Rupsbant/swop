...
public class LoginTest {
    ...
    public LoginInfo adminFoundTest(){
        ...
        assertEquals(admin.getRole(),"HospitalAdministrator");
        return admin;
    }
    ...
    public void loginTest() {
		...
		try {
			...
			assertEquals(adminLogin.getRole(),"HospitalAdministrator");
    ...
    public void loginTestWrongRoleArgument(){
    	...
    	LoginInfo info;
		try {
			info = new LoginInfo(adminFoundTest().getName(),"TestRole");
			adminLogin = wc.login(wc.getCampuses().get(0),info);
			fail("The login methode should throw an exception");
